...
export function SyncBadge() {
  ...
  const config = {
    idle: {
      ...
      label: status.pendingChanges > 0 ? t.syncBadge.pending.replace('{n}', String(status.pendingChanges)) : t.syncBadge.synced,
      textColor: 'text-green-700',
      bgColor: 'bg-green-50 border-green-200',
    },
    offline: {
      dotColor: 'bg-gray-400',
      label: t.syncBadge.offline,
